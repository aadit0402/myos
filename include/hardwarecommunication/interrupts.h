#ifndef __MYOS_HARDWARECOMMINCATION__INTERRUPTMANAGER_H
#define __MYOS_HARDWARECOMMINCATION__INTERRUPTMANAGER_H
...
namespace myos 
{
    namespace hardwarecommunication
    {
        ...
        protected:
            ...
            {  
                myos::common::uint16_t size;//for  the size
                myos::common::uint32_t base; //address of the table 
            } __attribute__((packed));
            myos::common::uint16_t hardwareInterruptOffset;
            static void SetInterruptDescriptorTableEntry(myos::common::uint8_t interrupt, myos::common::uint16_t codeSegmentSelectorOffset,
            void (*handler)(), myos::common::uint8_t DescriptorPrivilegeLevel, myos::common::uint8_t DescriptorType
            );
        ...
        //we have two differnet pic; the master and slave pic and we need to communicate both of them
